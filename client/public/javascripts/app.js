...
buf.push("<h1>" + (jade.escape(null == (jade_interp = t("panelSettings")) ? "" : jade_interp)) + "</h1><form id=\"settings\" role=\"form\"></form>");;return buf.join("");
};
if (typeof define === 'function' && define.amd) {
  define([], function() {
    return __templateData;
...
buf.push("" + (jade.escape((jade_interp = t("panelSettings " + model.paramId)) == null ? '' : jade_interp)) + "</label>");}.call(this,"model" in locals_for_with?locals_for_with.model:typeof model!=="undefined"?model:undefined));;return buf.join("");
};
if (typeof define === 'function' && define.amd) {
  define([], function() {
    return __templateData;
